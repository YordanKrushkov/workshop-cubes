...
router.get('/create/accessory',isLoggedIn,isAuthenticated, (req, res) => {
    res.render('createAccessory',{
        title: 'Create Accesory | Cube',
...
router.get('/attach/accessory/:id',isLoggedIn, isAuthenticated, async (req, res) => {
